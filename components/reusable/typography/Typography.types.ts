export type TypographyVarinats =
  | "h1"
  | "h2"
  | "h3"
  | "h4"
...
export const variantClasses: Record<TypographyVarinats, string> = {
...
export type TypographyColors =
  ...
  | "additional_pink"
  | "additional_blue"
  | "additional_dark_blue"
  | "background"
  | "divider"
  | "primary_text"
  | "text";

export const colorClasses: Record<TypographyColors, string> = {
  ...
  text: "text-text",
  additional_yellow: "text-additional_yellow",
  additional_pink: "text-additional_pink",
  additional_blue: "text-additional_blue",
  additional_dark_blue: "text-additional_dark_blue",
};
